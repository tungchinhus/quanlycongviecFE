...
@Component({
  ...
  templateUrl: './work-item-review-detail-dialog.component.html',
  styleUrls: ['./work-item-review-detail-dialog.component.css']
})
export class WorkItemReviewDetailDialogComponent implements OnInit {
